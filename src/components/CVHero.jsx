                ...
                <div className="grid lg:grid-cols-2 gap-12 max-w-7xl mx-auto items-center">
                    ...
                    <div className="text-center lg:text-left text-white">
                        ...
                        <p className="mt-6 text-lg md:text-xl text-gray-300 max-w-xl mx-auto lg:mx-0">
                            We are ready to help you add value to your business with ML algorithms for robust computer vision solutions with image analysis, object detection and video analysis.
                        </p>
                        <div className="mt-10">
                    ...
                    <div className="relative flex justify-center p-8">
                        ...
                        <img
                            src="https://usmsystems.com/wp-content/uploads/2021/05/Custom-Computer-Vision-Software.png"
