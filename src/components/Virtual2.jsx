            ...
            >
                <div className="relative z-10"> {/* Wrap content in relative div to ensure it's above background img */}
                    ...
                    <h2 className="text-white text-2xl md:text-3xl font-bold mb-4">
                        Develop your virtual assistant business tool today!
                    </h2>
                    <p className="text-white text-base md:text-lg mb-8 max-w-2xl mx-auto ">
                        Your business needs help with customer support? Contact us, and our engineers will
                        help you develop an AI virtual assistant software crafted to your needs.
                    </p>
                    <button
