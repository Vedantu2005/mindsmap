      ...
      <div className="container mx-auto px-4 py-20 lg:py-10">
        <div className="grid lg:grid-cols-2 gap-12 max-w-7xl mx-auto items-center">
          ...
          <div className="text-center lg:text-left text-white">
            <h1 className="text-4xl md:text-5xl lg:text-5xl font-extrabold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-blue-500">
            ...
            <p className="mt-6 text-lg md:text-xl text-gray-300 max-w-xl mx-auto lg:mx-0">
              Mindsmap AI, a data extraction company, provides high-quality services for you to find, capture, and extract data automatically from unstructured documents and automate work processes
            </p>
            <div className="mt-10">
