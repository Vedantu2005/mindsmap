...
const Sport2 = () => {
  ...
  return (
    <div className="bg-white font-sans py-8 md:py-10 -mt-7  lg:mt-0">
      <div className="container mx-auto max-w-6xl relative px-4">
        ...
        {/* Navigation Arrows - Repositioned for mobile */}
          <button 
            onClick={prevSlide} 
            className="absolute top-1/2 left-0 transform -translate-y-1/2 cursor-pointer text-gray-500 hover:text-gray-800 transition p-2 z-10 md:-left-12"
          ...
          <button 
            onClick={nextSlide} 
            className="absolute top-1/2 right-0 transform -translate-y-1/2 cursor-pointer text-gray-500 hover:text-gray-800 transition p-2 z-10 md:right-10"
