      ...
      <div className="container mx-auto px-4 py-20 lg:py-10">
        <div className="grid lg:grid-cols-2 gap-12 max-w-7xl mx-auto items-center">
          ...
          <div className="text-center lg:text-left text-white">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold pb-3 tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-cyan-300 to-blue-500">
              Machine Learning Consulting 
            </h1>
            <p className="mt-6 text-lg md:text-xl text-gray-300 max-w-xl mx-auto lg:mx-0">
              Explore new opportunities in your field with our machine learning consulting services.
            </p>
            <div className="mt-10">
          ...
          <div className="relative flex justify-center p-8">
              ...
              <img 
                  src="https://www.aitimejournal.com/wp-content/uploads/2019/11/ai-marketing-sales-blog.jpg" 
