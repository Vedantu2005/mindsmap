...
const Market3 = () => {
  ...
  // Auto-scrolling useEffect hook has been removed.

  return (
    <div className="bg-white font-sans py-8 md:py-10 -mt-10 lg:mt-0">
      <div className="container mx-auto max-w-6xl relative">
            ...
            {cardsData.map((card, index) => (
              <div key={index} className="w-full flex-shrink-0 px-4">
                <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12">
                  ...
                  {/* --- UPDATED: Image Content with New Design --- */}
                  <div className="w-full md:w-6/12 flex items-center justify-center p-4">
        ...
        <button 
          onClick={prevSlide} 
          className="absolute top-1/2 -left-13 cursor-pointer transform -translate-y-1/2 text-gray-500 hover:text-gray-800 transition p-2"
        ...
        <button 
          onClick={nextSlide} 
          className="absolute top-1/2 right-5 cursor-pointer transform -translate-y-1/2 text-gray-500 hover:text-gray-800 transition p-2"
