                ...
                <div className="grid lg:grid-cols-2 gap-12 max-w-7xl mx-auto items-center">
                    ...
                    <div className="text-center lg:text-left text-white">
                        ...
                        <p className="mt-6 text-lg md:text-xl text-gray-300 max-w-xl mx-auto lg:mx-0">
                            We use state-of-the-art natural language processing techniques to extract more value from your text data
                        </p>
                        <div className="mt-10">
                    ...
                    <div className="relative flex justify-center p-8">
                        ...
                        <img
                            src="https://cdn.mos.cms.futurecdn.net/DVffQnnibMWmNpx2Wfb5Se.jpg"
